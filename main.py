...
from app.services.inventory_import import build_inventory_items
  ...
  <main>
    ...
    <form method="post" action="/analyze" enctype="multipart/form-data">
      ...
      <div>
        ...
        <input id="inventory_excel" name="inventory_excel" type="file" accept=".xlsx,.xls,.csv">
        <div class="hint">字段：SKU、product_name、cost_price、inventory。可选字段：target_selling_price、category、status。</div>
      </div>
      <div class="manual">
